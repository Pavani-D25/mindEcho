...
export default function UserMenu() {
  ...
  const { streakData, loading, getStreakMessage } = useStreak();
      ...
      >
        ...
        {!loading && streakData.current > 0 && (
          ...
          >
            ...
            <span className="text-xs font-bold">{streakData.current}</span>
          </motion.div>
        )}
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-2">
                    <motion.div
                      ...
                      className={streakData.current > 0 ? "text-orange-500" : "text-gray-400"}
                    >
                  ...
                  <div className="text-right">
                    <div className={`text-lg font-bold ${
                      streakData.current > 0 ? "text-orange-500" : "text-gray-400"
                    }`}>
                      {streakData.current}
                    </div>
