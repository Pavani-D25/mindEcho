...
// // import { useState, useEffect } from "react";
// // import { Smile, Frown, Meh, Heart, Zap, Music, Film } from "lucide-react";
...
// //   return (
// //     <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-200 max-w-4xl mx-auto">
// //       <div className="flex justify-between items-center mb-6">
...
//   return (
//     // <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-200 max-w-5xl mx-auto">
