...
//       (activeTab === "journal" && journalText.trim())
//     ) {
...
//                   <span>
//                     {
//                       mediaLanguageOptions.find(
//                         (lang) => lang.code === mediaLanguage
//                       )?.flag
//                     }
//                   </span>
...
//                 <svg
//                   className="animate-spin h-4 w-4 mr-1 text-purple-500"
//                   viewBox="0 0 24 24"
//                 >
//                   <circle
//                     className="opacity-25"
...
//                   </h4>
//                 </div>
//                 <h5 className="text-gray-800 font-medium mb-1 text-sm sm:text-base">
//                   {aiResponse.exercise.title}
//                 </h5>
//                 <p className="text-gray-600 text-xs sm:text-sm mb-2 leading-relaxed">
//                   {aiResponse.exercise.description}
//                 </p>
//                 <div className="flex justify-between items-center text-xs text-gray-500">
//                   <span>{aiResponse.exercise.duration}</span>
//                   <span className="text-purple-500">AI Optimized</span>
...
//                 </h5>
//                 <p className="text-gray-600 text-xs sm:text-sm mb-2 leading-relaxed">
//                   {aiResponse.song.description}
//                 </p>
//                 <div className="flex justify-between items-center text-xs text-gray-500">
//                   <span>{aiResponse.song.duration}</span>
//                   <span className="text-blue-500">
//                     {mediaLanguage.toUpperCase()} Content
//                   </span>
//                 </div>
//               </div>
//             )}
...
//                 </div>
//                 <h5 className="text-gray-800 font-medium mb-1 text-sm sm:text-base">
//                   {aiResponse.movie.title}
//                 </h5>
//                 <p className="text-gray-600 text-xs sm:text-sm mb-2 leading-relaxed">
//                   {aiResponse.movie.description}
//                 </p>
//                 <div className="flex justify-between items-center text-xs text-gray-500">
//                   <span>{aiResponse.movie.duration}</span>
...
export default function MoodInputCard() {
      ...
      {/* <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 space-y-4 sm:space-y-0">
        ...
        <div className="flex items-center space-x-2">
          <div className="relative">
            <button
              onClick={() => setShowLanguageDropdown(!showLanguageDropdown)}
              className="flex items-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-2 bg-gray-100 rounded-full text-xs sm:text-sm hover:bg-gray-200 transition-colors min-w-[60px] sm:min-w-auto"
              disabled={isLanguageLoading}
            >
              {isLanguageLoading ? (
                <svg
            ...
            {showLanguageDropdown && (
              <div className="absolute right-0 mt-2 w-40 sm:w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-10 max-h-60 overflow-y-auto">
                <div className="px-3 py-2 text-xs font-semibold text-gray-500 border-b">
                  Media Language
                </div>
                {mediaLanguageOptions.map((language) => (
                  <button
                    key={language.code}
                    onClick={() => handleLanguageChange(language.code)}
                    className={`w-full text-left px-3 sm:px-4 py-2 hover:bg-gray-100 flex items-center space-x-2 text-sm ${
                      mediaLanguage === language.code
                        ? "bg-purple-50 text-purple-700"
                        : ""
                    }`}
  ...
  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-2 w-full sm:w-auto">
    {/* Language Selector for Media - Made Responsive */}
    <div className="relative w-full sm:w-auto">
      <button
        onClick={() => setShowLanguageDropdown(!showLanguageDropdown)}
        className="flex items-center justify-center sm:justify-start space-x-2 px-3 py-2 bg-gray-100 rounded-full text-sm hover:bg-gray-200 transition-colors w-full sm:w-auto"
        disabled={isLanguageLoading}
      >
        {isLanguageLoading ? (
          <svg
    ...
    <div className="flex space-x-1 bg-gray-100 p-1 rounded-full w-full sm:w-auto justify-center sm:justify-start">
      <button
        onClick={() => setActiveTab("mood")}
        className={`px-3 py-1 text-sm rounded-full transition-all ${
          activeTab === "mood"
