...
//         <div className="relative">
//           <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-600 rounded-2xl blur-xl opacity-20"></div>
//           <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 text-center max-w-md border border-white/20 shadow-xl">
//             <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">
//               <Sparkles className="w-8 h-8 text-white" />
//             </div>
//             <h3 className="text-xl font-bold text-gray-800 mb-2">No recommendations yet</h3>
...
//         >
//           <div className="absolute inset-0 bg-gradient-to-r from-blue-400/10 to-purple-600/10 rounded-3xl blur-2xl"></div>
//           <div className="relative bg-white/70 backdrop-blur-sm rounded-3xl p-4 sm:p-6 lg:p-8 border border-white/20 shadow-xl">
...
//                     {/* Icon */}
//                     <div className="flex items-center justify-between mb-4">
//                       <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-white/80 backdrop-blur-sm flex items-center justify-center shadow-lg">
//                         {getIcon(type)}
//                       </div>
//                       <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">
//                         {type}
...
//           <div className="flex space-x-2 bg-white/70 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20 max-w-full overflow-x-auto">
//             {history.map((rec, index) => (
//               <button
//                 key={rec.id}
//                 onClick={() => setCurrentIndex(index)}
